...
@property (nonatomic, copy) void (^_Nonnull willMoveToSuperviewAnimationBlock)(JMapMovableItem * _Nonnull view, UIView * _Nonnull superview); // default is pop animation
