...
/*!
 ...
 @param counterScale BOOL value to allow counter scale
 */
-(void)addComponent:(nonnull UIView*)component toMap:(nonnull JMapMap*)map atPoint:(CGPoint)point allowCounterRotate:(BOOL)counterRotate allowCounterScale:(BOOL)counterScale;
